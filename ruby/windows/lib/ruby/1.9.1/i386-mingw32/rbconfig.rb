...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--enable-shared' '--disable-install-doc' 'CPPFLAGS=-DFD_SETSIZE=32767' '--with-tcl-dir=C:/Users/Luis/Projects/oss/oneclick/rubyinstaller/sandbox/tcl' '--with-tk-dir=C:/Users/Luis/Projects/oss/oneclick/rubyinstaller/sandbox/tk' '--with-tklib=tk85-ri' '--with-tcllib=tcl85-ri' '--prefix=' 'LDFLAGS='"
  ...
  CONFIG["cppflags"] = "-DFD_SETSIZE=32767"
  CONFIG["NULLCMD"] = ":"
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-DFD_SETSIZE=32767 $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. "
